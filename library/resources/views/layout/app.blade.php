        ...
        <div class="w-2/12 h-full rounded-tr-[70px] bg-[rgb(34,98,198)]">
            <nav class="w-full h-4/6">
                <ul class="w-full h-full flex flex-col items-end justify-center">
                    <li class="w-10/12 text-start text-white font-medium tracking-wide my-4 hover:text-blue-200"><a href="">dashboard</a></li>
                    <li class="w-10/12 text-start text-white font-medium tracking-wide my-4 hover:text-blue-200"><a href="">books</a></li>
