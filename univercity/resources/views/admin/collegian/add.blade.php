...
@section('content')
    <div class="w-full h-5/6 flex justify-center py-4">
        <form action="{{route("insertLesson")}}" method="get">
            @csrf
...
--}}
            <div class="w-full flex justify-center mt-10">
                <input type="submit" value="SELECT STUDENT" class="cursor-pointer text-white bg-violet-950 rounded px-4 py-3 hover:bg-white hover:text-violet-950 border border-violet-900">
            </div>
        </form>
    </div>
@endsection
